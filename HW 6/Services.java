...
public class Services extends Account {
    ...
    public Services(double numberOfHours, double ratePerHour, String fullName, int accountNum) { // Non-Default Constructor
    ...
    public String toString() {
        ...
        return (super.toString() + " The cost for services is: " + df.format(calculateSales()));
    }
}